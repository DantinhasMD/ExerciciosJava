...
public abstract class Produto implements Residencia.ExerciciosAplicados.Exerc02.OperacoesProduto {
    private int codigo;
    private String nome;
    private double preco;
    private Residencia.ExerciciosAplicados.Exerc02.Cliente comprador;

    public double getPreco() {
        return preco;
    }

    public Produto(int codigo, String nome, double preco, Residencia.ExerciciosAplicados.Exerc02.Cliente comprador){
        this.codigo = codigo;
        this.nome = nome;
        this.preco = preco;
