...
public class Main {
    public static void main(String[] args) {
        Residencia.POO.Poo28.Cartao primeiro = new Residencia.POO.Poo28.CartaoCredito(12345, 100);
        Residencia.POO.Poo28.Cartao segundo = new Residencia.POO.Poo28.CartaoDebito(12344, 100, 30);
