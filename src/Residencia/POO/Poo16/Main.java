...
public class Main {
    public static void main(String[] args) {
        Residencia.POO.Poo16.ContaBancaria maria = new Residencia.POO.Poo16.ContaBancaria("Maria Dantas", "002");
        ...
        Residencia.POO.Poo16.ContaCorrente vitor = new Residencia.POO.Poo16.ContaCorrente("Vitor Cortez", "001", 345.67);
