...
public class Main {
    public static void main(String[] args) {
        Residencia.POO.Poo29.Investimento primeiro = new Residencia.POO.Poo29.RendaFixa(100);
        Residencia.POO.Poo29.Investimento segundo = new Residencia.POO.Poo29.RendaVariavel(100);
